                                        ...
                                        <div class="tab-pane active" id="Login">
                                            ...
                                            <div class="form-group">
                                                <label for="email" class="col-sm-2 control-label">
                                                    Email</label>
                                                <div class="col-sm-10">
                                                    <input type="email" class="form-control"name="email" id="email1" placeholder="Email" required="required" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <button type="submit" name="submit" class="submit btn btn-primary btn-sm">
                                                        Submit</button>
                                                    <a href="loginSignup" class="agileits-forgot">Signup for new account</a>
                                                </div>
                                            </div>
                                            @csrf
                                            </form>
